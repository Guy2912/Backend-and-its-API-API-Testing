...
app.config['BASIC_AUTH_PASSWORD'] = '1111'
basic_auth = BasicAuth(app)

# Escape username and password
username = quote_plus("nattanon")
password = quote_plus("@Guy22522")

# Connect to MongoDB
client = MongoClient(f"mongodb+srv://{username}:{password}@cluster0.odxerlw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client["students"]
